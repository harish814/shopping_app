...
class GirlsItems extends StatelessWidget {
  GirlsItems({this.title});
  final String title;
  @override
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              print('pressed');
                              Provider.of<CartModel>(context, listen: false).addCartItems(timage: 'images/g1.jpg', tcost: '120', titemName: ' girlthisrt');
                            },
                            iconSize: 20,
                          ),
                        )
